...
export function useChat() {
  ...
  const handleQuickOption = useCallback((message: string) => {
    ...
    // If we're at help_type step, go directly to handleUserInput (it will add the message)
